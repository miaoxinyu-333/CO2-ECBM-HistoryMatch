...
def main():
    ...
    setup_project_root()
    import torch
    from models.ForwardModelCreatorPCA import ForwardModelCreatorPCA
    ...
    # 加载 PCA 模型路径
    pca_model_path = "logs/PCA_PKL/pca_model.pkl"

    # 创建 ForwardModelCreatorPCA 实例
    creator = ForwardModelCreatorPCA(device=device)

    # 创建前向模型
    forward_model = creator.create_forward_model(pca_path=pca_model_path)
